...
# pansharpening
python train_pansharpening.py --idx 2 --data_path ../../DataSet --dataset CAVE --epochs 100 --train_size 64 --stride 32 --batch_size 16  --resume_demosaic ./1/model/best_982.pth --lr_decay --save_freq 5 --device 0
```

## ICVL
```
# demosaic
python train_demosaic.py --idx 3 --data_path ../../DataSet --dataset ICVL --epochs 200 --train_size 64 --stride 32 --batch_size 16 --lr_decay --save_freq 10 --device 1

# pansharpening
python train_pansharpening.py --idx 4 --data_path ../../DataSet --dataset ICVL --epochs 20 --train_size 64 --stride 64 --batch_size 16  --resume_demosaic ./3/model/best_70.pth --lr_decay --save_freq 5 --device 6
```

## Kaist
```
# demosaic
python train_demosaic.py --idx 5 --data_path ../../DataSet --dataset Kaist --epochs 200 --train_size 64 --stride 32 --batch_size 16 --lr_decay --save_freq 10 --device 1

# pansharpening
python train_pansharpening.py --idx 6 --data_path ../../DataSet --dataset Kaist --epochs 40 --train_size 64 --stride 64 --batch_size 16  --resume_demosaic ./5/model/best_77.pth --lr_decay --save_freq 5 --device 7
```
...
```
# all
python generate.py --idx 1 --mosaic_save --pan_save --demosaic_save --gt_save --data_path ../../DataSet/ --dataset ICVL --load_demosaic_model ./3/model/best_51.pth --load_ps_model ./4/model/best_32.pth 

# assign
python generate.py --idx 1 --mosaic_save --pan_save --demosaic_save --gt_save --data_path ../../DataSet --dataset ICVL --load_demosaic_model ./3/model/best_51.pth --load_ps_model ./4/model/best_32.pth --data_id peppers_0503-1330.mat
```

## Kaist
```
# all
python generate.py --idx 1 --mosaic_save --pan_save --demosaic_save --gt_save --data_path ../../DataSet/ --dataset Kaist --load_demosaic_model ./5/model/best_77.pth --load_ps_model ./6/model/best_40.pth 
# assign
python generate.py --idx 1 --mosaic_save --pan_save --demosaic_save --gt_save --data_path ../../DataSet --dataset Kaist --load_demosaic_model ./5/model/best_77.pth --load_ps_model ./6/model/best_40.pth --data_id scene21_reflectance.exr
```
