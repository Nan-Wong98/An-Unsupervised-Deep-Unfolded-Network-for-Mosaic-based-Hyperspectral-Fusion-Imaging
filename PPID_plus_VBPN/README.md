...
### pansharpening
```
python train_pansharpening.py --idx 4 --data_path ../../DataSet --dataset pavia --epochs 20 --train_size 64 --stride 16 --batch_size 8 --lr_decay --save_freq 5 --device 6
```

## 🟠 Chikusei
### pansharpening
```
python train_pansharpening.py --idx 6 --data_path ../../DataSet --dataset chikusei --epochs 100 --train_size 64 --stride 32 --batch_size 16 --lr_decay --save_freq 5 --device 4
```
...
### generate all
```
python generate.py --idx 1 --mosaic_save --pan_save --demosaic_save --gt_save --data_path ../../DataSet/ --dataset pavia --load_ps_model ./4/model/best_2.pth
```

### generate single
```
python generate.py --idx 1 --mosaic_save --pan_save --demosaic_save --gt_save --data_path ../../DataSet/ --dataset pavia --load_ps_model ./4/model/best_2.pth --data_id 1.mat
```

## 🟠 Chikusei
### generate all
```
python generate.py --idx 1 --mosaic_save --pan_save --demosaic_save --gt_save --data_path ../../DataSet/ --dataset chikusei --load_ps_model ./6/model/best_98.pth
```

### generate single
```
python generate.py --idx 1 --mosaic_save --pan_save --demosaic_save --gt_save --data_path ../../DataSet/ --dataset chikusei --load_ps_model ./6/model/best_98.pth --data_id 2.mat
```
