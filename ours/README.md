...
## 🟢 CAVE 
```
python train.py --idx 1 --data_path ../../DataSet --dataset CAVE --epochs 200 --train_size 64 --stride 32 --batch_size 16 --lr_decay --save_freq 50 --device 7 --shared --iters 2
```

## 🔵 Pavia
```
python train.py --idx 2 --data_path ../../DataSet --dataset pavia --epochs 200 --train_size 64 --stride 16 --batch_size 8 --lr_decay --save_freq 20 --device 7 --shared --iters 2
```

## 🟠 Chikusei
```
python train.py --idx 3 --data_path ../../DataSet --dataset chikusei --epochs 200 --train_size 64 --stride 32 --batch_size 16 --lr_decay --save_freq 20 --device 6 --shared --iters 2
```
...
### generate all
```
python generate.py --idx 1 --mosaic_save --pan_save --demosaic_save --gt_save --data_path ../../DataSet/ --dataset CAVE --load_model ./1/model/best_188.pth --shared --iters 2
```

### generate single
```
python generate.py --idx 1 --mosaic_save --pan_save --demosaic_save --gt_save --data_path ../../DataSet/ --dataset CAVE --load_model ./1/model/best_188.pth --shared --iters 2 --data_id jelly_beans_ms.mat
```

## 🔵 Pavia
### generate all
```
python generate.py --idx 1 --mosaic_save --pan_save --demosaic_save --gt_save --data_path ../../DataSet/ --dataset pavia --load_model ./2/model/best_149.pth --shared --iters 2
```

### generate single
```
python generate.py --idx 1 --mosaic_save --pan_save --demosaic_save --gt_save --data_path ../../DataSet/ --dataset pavia --load_model ./2/model/best_149.pth --shared --iters 2 --data_id 1.mat
```

## 🟠 Chikusei
### generate all
```
python generate.py --idx 1 --mosaic_save --pan_save --demosaic_save --gt_save --data_path ../../DataSet/ --dataset chikusei --load_model ./3/model/best_183.pth --shared --iters 2
```

### generate single
```
python generate.py --idx 1 --mosaic_save --pan_save --demosaic_save --gt_save --data_path ../../DataSet/ --dataset chikusei --load_model ./3/model/best_183.pth --shared --iters 2 --data_id 2.mat
```
